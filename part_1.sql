...
CREATE TABLE RAW.LGA_CODE (
	LGA_CODE INT PRIMARY KEY,
	LGA_NAME VARCHAR 
);


CREATE TABLE RAW.LGA_SUBURB (
	LGA_NAME VARCHAR,
	SUBURB_NAME VARCHAR PRIMARY KEY
);

TRUNCATE TABLE RAW.LISTING;
TRUNCATE TABLE RAW.CENSUS_G01;
TRUNCATE TABLE RAW.CENSUS_G02;
TRUNCATE TABLE RAW.LGA_CODE;
TRUNCATE TABLE RAW.LGA_SUBURB;